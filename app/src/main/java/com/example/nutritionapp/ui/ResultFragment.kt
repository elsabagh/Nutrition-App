...
//    private lateinit var mAdapterNutritionData: AdapterNutritionDataF
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addBreakfast.setOnClickListener { Navigation.findNavController(it).navigate(R.id.action_resultFragment_to_breakFastFragment2)}
        binding.addLunch.setOnClickListener { Navigation.findNavController(it).navigate(R.id.action_resultFragment_to_launchFragment2) }
        binding.addDinner.setOnClickListener { Navigation.findNavController(it).navigate(R.id.action_resultFragment_to_dinnerFragment2) }
        binding.addSnack.setOnClickListener { Navigation.findNavController(it).navigate(R.id.action_resultFragment_to_snacksFragment2) }
    }
